...
const faqs = [
  {
    q: "¿Tengo un límite de usuarios o empleados para usar el tablero?",
    a: "No, el plan incluye acceso para tu equipo sin costos por licencia individual. Todos los miembros pueden usar el gestor de proyectos, el CRM y las herramientas internas sin restricciones.",
  },
  {
    q: "¿Es muy difícil migrar la información que hoy tengo en Excel?",
    a: "Para nada. Nuestro equipo te ayuda a importar tus listas y clientes iniciales. Además, te preparamos los primeros tableros y flujos de trabajo para que arranques el primer día sin tener que configurar nada.",
  },
  {
    q: "¿Puedo pedir módulos adicionales según mi tipo de negocio?",
    a: "Sí, la plataforma está preparada para agregar campos a medida o reportes específicos. Si necesitas una funcionalidad particular, la desarrollamos sin costos de desarrollo adicional.",
  },
]
...
export default function FaqGestionPymes() {
    ...
    <>
        ...
        <div className="mx-auto max-w-3xl">
          <div className="text-center mb-14">
            ...
            <h2 className="text-3xl sm:text-4xl font-semibold text-white tracking-tight">
              Preguntas frecuentes sobre gestión PyME
            </h2>
          </div>
      ...
      <section className="relative px-4 sm:px-6 lg:px-8 pb-24 md:pb-32 bg-[#0b0f19]">
        <div className="mx-auto max-w-4xl">
          <div className="relative rounded-2xl border border-blue-500/20 bg-gradient-to-br from-[#131b2e] via-[#162240] to-[#131b2e] p-8 sm:p-12 md:p-16 text-center overflow-hidden">
            {/* Corner decorations */}
            <div className="absolute top-0 right-0 w-24 h-24 border-t-2 border-r-2 border-blue-500/20 rounded-tr-2xl" />
            <div className="absolute bottom-0 left-0 w-24 h-24 border-b-2 border-l-2 border-blue-500/20 rounded-bl-2xl" />

            <div className="relative z-10">
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-semibold text-white tracking-tight leading-tight">
                ¿Querés ver cómo funcionaría el tablero de tu PyME?
              </h2>
              <p className="mt-4 text-sm sm:text-base text-slate-400 max-w-xl mx-auto">
                Te preparamos una demo en vivo configurada con el nombre y los procesos de tu empresa en 15 minutos.
              </p>
