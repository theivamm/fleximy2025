const features = [
  ...
  "Portal de clientes con visor de avances en tiempo real",
  "CRM de ventas con pipeline y seguimiento de leads",
  "Time tracking para medir rentabilidad por proyecto",
  "Repositorio de documentos y entregables",
  "Asignación de roles y permisos por empleado",
  "Soporte directo por WhatsApp en horario laboral",
]

export default function PlanGestionPymes() {
  return (
      ...
      <div className="mx-auto max-w-7xl">
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl font-semibold text-white tracking-tight">
            Un plan. Sin límites. Sin sorpresas.
          </h2>
        </div>

        <div className="max-w-2xl mx-auto">
          <div className="relative rounded-2xl border border-slate-700/50 bg-gradient-to-b from-[#131b2e] to-[#0f1729] p-8 sm:p-10 shadow-2xl hover:shadow-[0_0_40px_-12px_rgba(59,130,246,0.15)] transition-shadow duration-500">
            {/* Price */}
            ...
            {/* Bonus */}
            <div className="rounded-xl bg-gradient-to-r from-amber-500/10 via-amber-500/5 to-transparent border border-amber-500/20 p-4 mb-8">
              <div className="flex items-start gap-3">
                <span className="text-xl">🎁</span>
                <div>
                  <div className="text-sm font-semibold text-amber-400 mb-1">Puesta en Marcha Personalizada</div>
                  <p className="text-xs text-slate-400 leading-relaxed">
                    Armamos tus primeros tableros, columnas y flujos de trabajo iniciales gratis.
                  </p>
                </div>
              </div>
            </div>
