  ...
  return (
    ...
    >
      <span className="relative flex h-7 w-12 shrink-0 items-center overflow-hidden rounded-full border border-outline bg-surface-2 transition-colors duration-300">
        ...
        >
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" className={`col-start-1 row-start-1 text-[#ffb45e] transition-opacity duration-300 ${isDark ? "opacity-0" : "opacity-100"}`}>
          ...
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" className={`col-start-1 row-start-1 text-[#9aa7ff] transition-opacity duration-300 ${isDark ? "opacity-100" : "opacity-0"}`}>
